        ...
        <main className=" flex items-center justify-around mt-[130px] mb-[150px] flex-wrap">
            ...
            <div className="w-1/2 max-md:w-[90%] text-center md:text-left">
                ...
                <div className="flex gap-3 justify-center md:justify-start">
                    ...
                    <button className="px-[18px] py-2 text-[15px] border-2 border-white bg-transparent rounded hover:text-[#0091ff] hover:border-[#0091ff] cursor-pointer transition-colors">Contact us</button>
                </div>
